...
public class DiscussionEntryThreadModifiedComparable implements Comparator<DiscussionEntry> {

	@Override
	public int compare(DiscussionEntry lhs, DiscussionEntry rhs) {
		
		String lhsDate = lhs.getThreadLastModifiedDate();
		String rhsDate = rhs.getThreadLastModifiedDate();
